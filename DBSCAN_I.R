...
abline(h=0.055, col = "red", lty=2) #----------------- Note

res <- dbscan(dataSample, eps = 0.055 , minPts = 5)
res
...
# setwd('F:/All Data Forests2020/29032019_Pavilion/CIDANAU NO_NORMALIZE/') #---------------------- After running
# write.xlsx(cleanall, file = "CIDANAU_29032019_68.16.xlsx")
